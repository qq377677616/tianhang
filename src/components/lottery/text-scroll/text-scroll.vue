...
<script type="text/ecmascript-6">
  export default {
    props: {
      ...
      textList: {
        type: Array,
        default: [{amount: 1, userName: "测试账号", issueNo: "2019003", option: 1},
                  {amount: 1, userName: "202", issueNo: "2019003", option: 1},
                  {amount: 1, userName: "203", issueNo: "2019003", option: 1},
                  {amount: 1, userName: "204", issueNo: "2019003", option: 1},
                  {amount: 1, userName: "205", issueNo: "2019003", option: 1},
                  {amount: 1, userName: "206", issueNo: "2019003", option: 1}
                  ]
      },
      scrollType: String    
    }, 
